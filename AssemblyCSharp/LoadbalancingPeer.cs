...
public class LoadbalancingPeer : PhotonPeer
{
    ...
    public void testOpJoin(bool sendReliable, RaiseEventOptions raiseEventOptions) {
        Dictionary<byte, object> customOpParameters = new Dictionary<byte, object>();
        customOpParameters[0xf4] = (byte) 255;
         ...
         * */
        customOpParameters[0xFC] = new int[] {PhotonNetwork.player.ID };
        ...
        this.OpCustom(0xfd, customOpParameters, sendReliable, raiseEventOptions.SequenceChannel, false);
    }
