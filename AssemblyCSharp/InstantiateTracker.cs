...
public class InstantiateTracker
{
    ...
    private HashSet<string> allowedNonMCSpawns = new HashSet<string>();

    public InstantiateTracker() {
        this.allowedNonMCSpawns.Add("rcasset/bombmain");
        this.allowedNonMCSpawns.Add("rcasset/bombexplodemain");
    }
